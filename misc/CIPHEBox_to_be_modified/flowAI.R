...
#   print(lowerRateThres)
#   print(upperRateThres)
#   # print(frequencies)
#   frg <- plot(frequencies[,3],frequencies[,4],col="red",type="l",
#               ylab = paste0("Number of cells per 1/", 1/second_fraction, " second"),
#               xlab = "Seconds")
#   
#   return(frg)
# }
...
#   data$binID <- binID
#   # print(colnames(exprsBin))
#   
#   longdata <- melt(data, id.vars = "binID", variable.name = "variable", value.name = "value")
#   # print(longdata)
#   FS_graph <- ggplot(longdata, aes(x = binID, y = value, col = variable), environment = environment()) +
